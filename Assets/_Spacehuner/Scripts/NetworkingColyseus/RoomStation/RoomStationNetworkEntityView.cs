...
{
    public class RoomStationNetworkEntityView : MonoBehaviour
    {
        ...
        private RoomStationNetworkEntity _previousState = default;

        private RoomStationNetworkEntity _state = default;



        public void InitView(RoomStationNetworkEntity entity, bool isMine)
        {
            _state = entity;
            IsMine = isMine;
        ...
        private void UpdateStateFromView()
        {
            ...
            if(changes.Count > 1)
            {
                RoomStationManager.Instance.SendAction(RoomStationAction.EntityUpdate, changes);
            }
        }

        private Dictionary<string, object> CompareChange(RoomStationNetworkEntity oldState, RoomStationNetworkEntity newState)
        {
