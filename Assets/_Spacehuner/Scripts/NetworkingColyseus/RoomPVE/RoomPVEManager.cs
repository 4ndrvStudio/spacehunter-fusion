...
{
    public class RoomPVEManager : ColyseusManager<RoomPVEManager>
    {
        private RoomPVEController _roomController;

        private RoomPVEEntityFactory _networkEntityFactory;

        public RoomPVENetworkEntity CurrentNetworkEntity => _roomController.CurrentNetworkEntity;

        public bool IsInRoom => _roomController.Room != null;

        public ColyseusRoom<RoomPVEState> Room => _roomController.Room;
        ...
        public override void InitializeClient()
        {
            ...
            _roomController = new RoomPVEController(client);
            _networkEntityFactory = new RoomPVEEntityFactory(_roomController.Entities, _roomController.EntityViews);
        }
        ...
        public RoomPVENetworkEntityView GetEntityView(string id)
        {
