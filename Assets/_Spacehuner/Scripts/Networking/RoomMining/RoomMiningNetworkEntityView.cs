...
{
    public class RoomMiningNetworkEntityView : MonoBehaviour
    {
        ...
        private RoomMiningNetworkEntity _previousState = default;

        private RoomMiningNetworkEntity _state = default;



        public void InitView(RoomMiningNetworkEntity entity, bool isMine)
        {
            _state = entity;
            IsMine = isMine;
        ...
        private void UpdateStateFromView()
        {
            ...
            if (changes.Count > 1)
            {
                RoomMiningManager.Instance.SendAction(RoomMiningAction.EntityUpdate, changes);
            }
        }

        private Dictionary<string, object> CompareChange(RoomMiningNetworkEntity oldState, RoomMiningNetworkEntity newState)
        {
