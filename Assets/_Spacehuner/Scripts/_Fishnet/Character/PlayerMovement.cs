...
namespace SH.Multiplayer.Player
{
    ...
    public class PlayerMovement : NetworkBehaviour
    {
        ...
        private void CheckInput(out MoveData md)
        {
            ...
            if (_playerState.IsAbility == true)
                return;
        ...
        private void AssignAnimationIDs()
        {
            ...
            _animIDGrounded = Animator.StringToHash("onGround");
            _animIDJump = Animator.StringToHash("Jump");
            _animIDFreeFall = Animator.StringToHash("FreeFall");
            _animIDMotionSpeed = Animator.StringToHash("test");
        }
        ...
        private void MoveWithData(MoveData md, float delta)
        {
            ...
            if (md.Move == Vector2.zero || _playerState.IsAttack == true) targetSpeed = 0.0f;
            ...
            {
                if (_playerState.IsAbility == true || _playerState.IsAttack == true)
                {
                    _animator.applyRootMotion = true;
                    Vector3 targetPos = _animator.deltaPosition;
                    targetPos.y = 0;
