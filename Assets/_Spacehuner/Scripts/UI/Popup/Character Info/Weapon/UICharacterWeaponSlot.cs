...
namespace SH.UI
{
    public class UICharacterWeaponSlot : MonoBehaviour
    {

        //PUBLIC MEMEBER
        [HideInInspector] public int Level;
        [HideInInspector] public UICharacterInfoPanel_Weapon _uiWeaponPanel;
        ...
        public void Setup(int level , ItemConfig itemConfig, string address, UICharacterInfoPanel_Weapon weaponUI) {
